...
def main():
    c = Classify("train5.txt") #"trainout.txt"
    a = c.obj_create()
    l1 = L1(a, "train_l5.txt") #"train_label.txt"
    l1.data_input(a)
    l1.lang_input("train_l5.txt") #"train_label.txt"
    l1.log_obj()
    c1 = Classify("test5.txt") #"testout.txt"
    a1 = c1.obj_create()
    l1.data_input(a1)
    l1.lang_input("test_l5.txt") #"test_label.txt"
    l1.log_obj()
    l1.predict_lang(a1)
